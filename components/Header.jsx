...
const Header = () => {
  ...
  let Links = [
    {
      name: language === "en" ? "timeline" : "kronologjia",
      link: "/timeline",
    },
    {
      name: language === "en" ? "work" : "puna",
      link: "/work",
    },
    {
      name: language === "en" ? "about" : "rreth",
      link: "/about",
    },
    {
      name: language === "en" ? "tech" : "teknologjia",
      link: "/tech",
    },
    {
      name: language === "en" ? "English" : "Shqip",
        ...
        >
          {Links.map((link) => (
            <li key={link.name} className="md:ml-8 text-base md:my-0 my-7">
              {link.isLanguageToggle ? (
                <button
                  onClick={() => setLanguage(language === "en" ? "sq" : "en")}
                  className="text-gray-700 dark:text-white font-out hover:text-purple-500 dark:hover:text-purple-500 duration-500"
                >
                  {language === "en" ? "english" : "shqip"}
                </button>
              ) : (
                <Link
                  href={link.link}
                ...
                >
                  <span>
                    {link.name}
                    {link.name ===
                      (language === "en" ? "timeline" : "kronologjia") && (
